...
public class Song extends Score {
	 ...
	 * 
	 * @param trackNo	The index of the track in question.
	 * @param tag		The tag to be applied to the track.
	 */
	 ...
	 * 
	 * @param trackIndex	The index of the track from which the tag is requested.
	 * @return	The corresponding tag for the given track index if any, otherwise NONE
	 */
	public TrackTag getTrackTag(int trackIndex) {
		return TrackTag.NONE;
		// TODO implement actual code.
		// What happens if trackIndex is out of bounds? throw IndexOutOfBoundsException?
	}
	
	/**
	 * Given a tag, returns all tracks that has that tag.
	 * 
	 * @param tag	The tag which will be looked up.
	 * @return	A list with all tracks corresponding to the given track if any, else an empty list.
	 */
